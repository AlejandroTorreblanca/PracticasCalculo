...
public class PolinomioInterpolador extends Polinomio{
    ...
    /**
     * Constructor de un polinomio interpolador a partir de una lista de nodos y coeficientes. Si usamos interpolación de Lagrange
     * cada fila tendrá solo dos elementos.
     * @param xy Puede contener valores de derivadas, será de la forma {Xj,Y(j,0),Y(j,1)...Y(j,k)}
     */
    ...
    @Override
    /**
     * Sobrecarga del método de evaluación para usar la fórmula anidada correspondiente a la forma de Newton
     */

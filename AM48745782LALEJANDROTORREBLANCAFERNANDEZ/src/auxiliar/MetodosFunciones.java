...
public class MetodosFunciones {
    ...
    /**
     * Evalua la función f en un número determindo de puntos equiespaciados en el intervalo[a,b] y retorna el resultado.
     * @param f funció a evaluar.
     * @param numpuntos número de puntos a evaluar
     * @param a inicio del intervalo.
     * @param b final del intervalo
     * @return  lista de puntos [xi,f(xi)]
     */
    ...
    /**
     * Retorna una lista de los valores de la función f en los N nodos de Chebychev.
     * @param f
     * @param N
     * @param a
     * @param b
...
/**
 * Clase para aproximar la derivada de una función en un punto con el cociente
 * (f(x+h)-f(x))/h
 ...
 */
   ...
   * la aproximación es de orden 0(h^2)
    */
    ...
    /**
     * Clase para calcular la derivada de una función mediante 5 puntos.
     */
    ...
    /**
     * Clase para calcula la derivada de una funcion mediante extrapolación, ejemplo de uso en EjemploDerivadas.
     */

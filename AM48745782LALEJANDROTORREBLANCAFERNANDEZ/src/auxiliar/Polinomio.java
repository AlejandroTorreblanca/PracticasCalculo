...
public class Polinomio implements Funcion {
    ...
    /**
     * Retorna los coeficiente del polinomio como una lista de número complejos.
     * @return 
     */
    ...
    /**
     * Metodo para construir la lista de los factores de lagrange Li(x) correspondientes a una lista de 
     * numeros reales. Los factores son interpretados como polinomios.
     * @param xs
     * @return Li(x)
     */
    ...
    /**
     * Construye un polinomio interpolador mediante el método de Lagrange pero sin hacer uso de la clase PolinomioInterpolador.
     * @param xys
     * @return 
     */
    ...
    /**
     * Devuelve una lista con los valores de las n primeras derivadas del Polinomio en el
     * punto x calculadas de forma simultánea con el método de Horner. 
     * @param x
     * @param n
     * @return 
     */
    ...
    */
    ...
    /**
     * Construye el polinomio an(x-x1)(x-x2)...(x-xn) 
     * @param an
     * @param raices
     * @return 
     */
     ...
     * sobre el que se aplica utilizando el método de aproximación de newton en un punto inicial
     * aleatorio, con un número máximo de intentos.
     ...
     * Devuelve una lista con los polinomios de Legendre de grado 1,2,3...n.
     * @param n
     * @return 
     */
    ...
    /** Metodo que devuelve una lista con las raices reales del polinomio
     * en el intervalo [a,b].
     *
